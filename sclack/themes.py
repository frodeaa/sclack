themes = {
    'minimal': [
        ...
        ('cite', '', '', '', 'italics,white', ''),
        ('app_badge', '', '', '', 'h235', 'h248'),
        ('field_title', '', '', '', 'white,bold,underline', ''),
        ('field_value', '', '', '', 'h253', ''),
        ('italics', '', '', '', 'italics,white', ''),
        ('bold', '', '', '', 'bold', ''),
        ('code', '', '', '', 'h124', 'h252'),
        ('loading_message', '', '', '', 'white', ''),
        ('loading_active_block', '', '', '', 'h99', ''),
        ('edit_topic_focus', '', '', '', 'h27', ''),
        ('editing_message', '', '', '', 'black', 'h178'),
        ('new_messages_text', '', '', '', 'h249', 'h197'),
        ('new_messages_line', '', '', '', 'h197', ''),
        ...
        ('quick_switcher_dialog', '', '', '', 'white', ''),
        ('set_snooze_dialog', '', '', '', 'white', ''),
        ('active_quick_switcher_item', '', '', '', 'white', 'h32'),
        ('active_set_snooze_item', '', '', '', 'white', 'h32'),
        ('quick_search_presence_active', '', '', '', 'h40', ''),
        ('quick_search_active_focus', '', '', '', 'h40', 'h32'),
        ('quick_search_presence_away', '', '', '', 'white', '')
    ],
    'default': [
        ('sidebar', '', '', '', 'white', 'h54'),
        ('profile', '', '', '', 'white', 'h233'),
